...
echo"<script>  </script>";
   ...
   $fullname= $_SESSION['full_Name'];
    $email_premium=$_SESSION['email_premium'];
    ...
    $sel="SELECT * FROM activating_table WHERE email='$email_premium' ";
    //echo"I dey here";
    $run=mysqli_query($conn,$sel);
    ...
    if($date==$expiry_date)
    {
      ...
      $sel="UPDATE client_premium SET active='0' WHERE email='$email_premium'";
      $run=mysqli_query($conn,$sel);
      //echo"I dey here 2";
      $_SESSION['active']= "0";
...
<li class="nav-item">
 ...
 <!-- <li class="nav-item">
    <a class="page-scroll" href="registration.php">Sign up</a>
    </li> -->

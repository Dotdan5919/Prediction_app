...
$run= mysqli_query($conn,$sel);
$fetch_client_active_premium=$run;
...
-->
                <div class="col-lg-4 col-md-6 col-xs-12">
                  <div class="follow">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">New Clients (Premium)</h4>
                        <div class="card-toolbar">
                          <ul>
                            <li>
                              <a class="text-gray" href="#">
    ...
    while( $row=mysqli_fetch_array($fetch_client_inactive_premium))
      {
...
-->
    ...
    while( $row=mysqli_fetch_array($fetch_client_active_premium))
      {
        $name= $row['first_Name']." ". $row['last_Name']; 
        $package=$row['package'];
        $email= $row['email'];
        
$sel="SELECT * FROM activating_table WHERE package='premium' AND email='$email' ";
$run= mysqli_query($conn,$sel);

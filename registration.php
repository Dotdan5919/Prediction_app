...
<head>
    ...
    <!--====== Title ======-->
    <title>Prediction Website | Registration</title>
                           ...
                           <form action="reg.php" method="POST" onsubmit="return validateForm()" >
                               ...
                               <div class="single-form form-default form-border">
                                ...
                                <div class="single-form form-default form-border">
                                    ...
                                    <div class="form-input">
                                        <input name="password" required id="password-5" 
                                ...
                                <div class="single-form form-default form-border">
                                    ...
                                    <div class="form-input">
                                        <input name="password2" required id="password-4" type="password"
                                        maxlength="12" minlength="8" title="Your Password must 
                                ...
                                <div class="single-form">
                                    <button name="signup_basic" type="submit" class="main-btn primary-btn">Signup</button>
                                </div>
                           </form>
                       </div>
...
else
{
    ...
    alert("inconsistent password");
       ...
       <!--         
                <div class="col-lg-6">
                   <div class="login-registration-style-1 login-registration-dark-style-1 registration mt-50">
                       <h1 class="heading-4 font-weight-500 title">Create an Account with</h1>
                       <div class="login-registration-form pt-10">
                           <form action="reg.php" method="POST" onsubmit="return validateForm()" >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-input">
                                                ...
                                                maxlength="100" required type="text" placeholder="First Name">
                                                <i class="mdi mdi-account"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                               ...
                               <div class="single-form form-white form-border">
                                ...
                                <div class="single-form form-white form-border">
                                    <label>Choose Password</label>
                                    <div class="form-input">
                                        <input  name="password" required maxlength="12" minlength="8" title="Your Password must 
                                        contain a number and must not be less than 8"
                                        id="password-4" type="password" placeholder="Password">
                                        <i class="mdi mdi-lock"></i>
                                ...
                                <div class="single-form form-white form-border">
                                    ...
                                    <div class="form-input">
                                        <input  name="password2" required id="password-5" 
                                        maxlength="12" minlength="8" title="Your Password must 
                                        contain a number and must not be less than 8"
                                ...
                                <div class="single-form">
                                    <button name="signup_basic" type="submit" class="main-btn secondary-1-btn">Signup</button>
                                </div>
                           </form>
                       </div>
                       <p class="login">Have an account? <a href="#0">Log in</a></p>
